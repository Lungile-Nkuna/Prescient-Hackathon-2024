---
title: "prescient coding challenge"
author: "Tech Knights"
date: "2024-10-05"
...
# Load data
df_sectors <- read.csv('prescient-coding-challenge-2024/data/data0.csv')
df_data <- read.csv('prescient-coding-challenge-2024/data/data1.csv')
...
# Load returns data
df_returns <- read.csv('prescient-coding-challenge-2024/data/returns.csv')
